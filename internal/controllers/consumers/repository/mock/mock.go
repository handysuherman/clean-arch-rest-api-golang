...
// Source: internal/controllers/consumers/repository/repository.go
//
...
import (
	...
	repository "github.com/handysuherman/studi-kasus-pt-xyz-golang-developer/internal/controllers/consumers/repository"
...
func (m *MockRepository) CountList(ctx context.Context, arg *repository.CountListParams) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountList", ctx, arg)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) CountList(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountList", reflect.TypeOf((*MockRepository)(nil).CountList), ctx, arg)
}
...
func (m *MockRepository) FindByID(ctx context.Context, id int64) (*repository.Consumer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByID", ctx, id)
	ret0, _ := ret[0].(*repository.Consumer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Get(ctx context.Context, key string) (*repository.Consumer, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(ctx context.Context, arg *repository.ListParams) ([]*repository.Consumer, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Put(ctx context.Context, key string, arg *repository.Consumer) {
	m.ctrl.T.Helper()
