...
// Source: internal/controllers/consumer_loan_limits/repository/repository.go
//
...
import (
	...
	repository "github.com/handysuherman/studi-kasus-pt-xyz-golang-developer/internal/controllers/consumer_loan_limits/repository"
...
func (m *MockRepository) FindByID(ctx context.Context, id int64) (*repository.ConsumerLoanLimit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByID", ctx, id)
	ret0, _ := ret[0].(*repository.ConsumerLoanLimit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Get(ctx context.Context, key string) (*repository.ConsumerLoanLimit, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(ctx context.Context, arg *repository.ListParams) ([]*repository.ConsumerLoanLimit, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Put(ctx context.Context, key string, arg *repository.ConsumerLoanLimit) {
	m.ctrl.T.Helper()
